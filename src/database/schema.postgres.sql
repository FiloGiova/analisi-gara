...
CREATE TABLE IF NOT EXISTS reports (
  ...
  report_type TEXT NOT NULL DEFAULT 'full' CHECK (report_type IN ('full', 'video')),
...
CREATE TABLE IF NOT EXISTS competition_sources (
  ...
  sport_season     TEXT NOT NULL,
  name             TEXT NOT NULL,
  source_type      TEXT NOT NULL DEFAULT 'fip_public' CHECK (source_type IN ('fip_public', 'fip_analytics')),
  url              TEXT NOT NULL,
  params_json      TEXT,
  competition      TEXT,
  active           INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE IF NOT EXISTS games (
  ...
  external_source       TEXT NOT NULL DEFAULT 'manual' CHECK (external_source IN ('fip_public', 'fip_analytics', 'xlsx', 'manual')),
...
CREATE TABLE IF NOT EXISTS game_officials (
  ...
  source        TEXT NOT NULL DEFAULT 'manual' CHECK (source IN ('fip_public', 'fip_analytics', 'xlsx', 'federation_pdf', 'manual')),
